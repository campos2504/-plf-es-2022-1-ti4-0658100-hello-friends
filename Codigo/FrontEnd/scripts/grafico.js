...
function getMedalha() {
    let baseURLBuscaMedalhas = `https://tishellofriends.azurewebsites.net/api/medalha`;
  ...
  function getModulo() {
    let baseURLModulo = `https://tishellofriends.azurewebsites.net/api/modulos/qtdModulosConcluidos`;
    let request = new XMLHttpRequest();
